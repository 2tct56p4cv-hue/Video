...
scenes = [
  ("s1", "Behind every successful technology transformation, there is much more than technology. There are people who understand the data, build the solutions, test their quality, modernize the platforms, and make sure everything works when it matters most. That is where our Technology Team comes in."),
  ("s2", "Our Data Engineers and Analytics specialists turn complex information into something businesses can actually use. We build reliable data pipelines, improve data quality, and transform large volumes of financial data into trusted insights. From SQL and Python to BigQuery, GCP and Airflow, we help move data from complexity to business value."),
  ...
  ("s4", "But building something is only part of the journey. Our Testing and Quality specialists make sure solutions actually work, reliably, securely, and at scale. From test strategy and automation to performance testing and QA leadership, we identify problems before they become business problems."),
